...
# Skills needed as a developer (2025)

::: {.summary}
📘 **Developer skills summary**

- Algorithmic, OOP, COP, Scripting
...
- **Artificial Intelligence**, developers need AI literacy, data fluency (to create syntetic data), and algorithmic thinking to code effectively. Understanding context, planning AI integration:
  - [Claude Code](https://github.com/anthropics/claude-code){.external target='_blank'}
  - [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook){.external target='_blank'}
  - [Anthropic Academy](https://www.anthropic.com/learn){.external target='_blank'}


## What is a developer (2025)
