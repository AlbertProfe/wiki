...
|   | 04 | 19/09/2029 | - Git: version control </br>  - Project Maven Renting Car: </br> (0) Project in 4 steps: Project > DDD > UML > Code </br> (1) UML </br> (2) Maven Project </br> (3) Entity classes </br></br> - static vs. non-static |  - [Maven Create Project](/javase/se-concepts-createproject.qmd){.external target='_blank'}  </br>  - [Git](/devops/devops-vc-git.qmd){.external target='_blank'} |
