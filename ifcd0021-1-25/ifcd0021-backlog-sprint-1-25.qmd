...
|   |
|   | 03 | 18/09/2025 | - How to plan </br>  - Create a Spring Boot Project: debugg </br> - MVC: how it works </br>  - Spring Boot as a Restaurant  </br> - Java SE: scope </br> - Thymeleaf: what is a template engine | - [Maven Create Project](/javase/se-concepts-createproject.qmd){.external target='_blank'}  </br> - [Java Version Switch](https://stackoverflow.com/questions/59856882/how-to-switch-between-different-java-versions-in-linux){.external target='_blank'} |
|   | 04 | 19/09/2029 |  |   |
