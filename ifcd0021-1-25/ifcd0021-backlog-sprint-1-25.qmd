...
|   |
|   | 07 | 25/09/2025 | - Git </br> </br>  - Project: rentingCar: <br> (1) UML, booking object  <br> (2) UI: cli interaction <br> (3) Class Repository: HashMap vs. List  <br>  (4) Main Loop: scanner | - [Coupling](/javase/se-concepts-coupling.qmd){.external target='_blank'}</br> - [Git](/devops/devops-vc-git.qmd){.external target='_blank'} </br> - [Git & gh basic commands](https://gist.github.com/AlbertProfe/b05e8198f02b311d18e7c4a86c5241e0){.external target='_blank'} </br> - [gh auth login](https://cli.github.com/manual/gh_auth_login){.external target='_blank'}</br></br>   - [Repo rentingCar](https://github.com/AlbertProfe/rentingCarTest){.external target='_blank'}  |
