...
|   | 36 | 30/10/2024 | - Lab#SB08-4 Spring Boot RestaurantManager: </br> (1) Inherence: Order implementation </br> (2) Order: Interface? Abstract? </br>  (3) @Service and @RestController of all @Entitty </br> (4) Profile **Local H2** </br> (5)  **DataLoader and DataPopulate** </br> </br>  |  - [Lab#SB08-4](/springboot/sblab8-4.qmd){.external target='_blank'} </br></br>  |
