...
|   | 45 | 13/11/2024 | - Vaadin / Thymeleaf  </br>  (1) Spring IO Conference UML </br>  (2) Model, DB H2, Properties. JPA   </br>  (3)  <s>JUnit Tests</s> </br>  (4) Vaadin: **Routing** | - [RestaurantVaadin: 33b1284](/springboot/sblab8-2.qmd) </br></br>  - [BooksPageable](https://github.com/AlbertProfe/BooksPageable){.external target='_blank'}  </br>  - [Spring IO](https://2025.springio.net/){.external target='_blank'}  |
