...
| | 76 | 20/05/2025 |  - rentingCar: </br> (1) auth AWS Cognito customUI  </br> </br>  - AWS Cognito customUI / hostedUI </BR> - What? For What? How? Why? Context?  </br> </br>  - **auth AWS Cognito HostedUI**: authReactCognitoHosted repo : </br> (1) urls redirects  </br> (2) libraries: context and cognito </br> (3) client-side auth: cookies & session storage </br> (4) **useAuth**   |  - [rentingCar: repo](https://github.com/AlbertProfe/rentingCar){.external target='_blank'} </br> - [rentingCar: auth](https://github.com/AlbertProfe/rentingCar/tree/master/docs/core-concepts/auth){.external target='_blank'} </br> - [authReactCognitoHosted: repo ](https://github.com/AlbertProfe/authReactCognitoHosted){.external target='_blank'} </br> </br>  ![](/images/ifcd0210-25/hostedUI-cognito-network.png){.lightbox width=80% fig-align="center"}|
| |
