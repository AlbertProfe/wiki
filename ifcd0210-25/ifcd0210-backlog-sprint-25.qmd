...
| -- | -- | -- | -- | -- |
| #14 | 53 | 31/03/2025 | - React; </br> (1) Context: create & provider   </br> (2) custom hook </br> (3) centralized `.js axios` file </br> (4) Context: `useContext` </br> (5) feature: `book` detail    |  - [userBorrowBookFront](https://github.com/AlbertProfe/userBorrowBookFront){.external target='_blank'} |
| | 54 | 01/04/2025 |- React; </br> (1) Context: create & provider   </br> (2) custom hook </br> (3) centralized `.js axios` file </br> (4) Context: `useContext` </br> (5) feature: `book` detail      |  - [userBorrowBookFront](https://github.com/AlbertProfe/userBorrowBookFront){.external target='_blank'}  |
| |
